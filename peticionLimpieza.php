...
<div class="container-fluid" style="height:60vh; margin-top: 40px;">
  <div class="row" style="height: 100%;">
    <div class="col-lg-2 col-md-12" style="height: 100%; width:100%;">
      <label class="etiquetaSubapartados" for="">Tipo de prenda</label>
      <div class="card bg-light text-center" style="height: 91%; width:100%; overflow-x: hidden; overflow-y: auto;">
    ...
    <div class="col-lg-10 col-md-12" style="height: 100%;">
